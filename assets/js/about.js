...
// about text
const aboutTextP1 = '  A full stack developer with a passion for frontend. I am a University of Denver full-stack coding Bootcamp graduate, with a BFA looking for a place to grow his skills. I love that coding feeds my creative side and the need for a challenge.'
const aboutTextP2 = 'From 2015 to 2020, I was the lab/social media manager at Denver Pro Photo. While working hands-on with clients to provide high-quality lab services, I additionally managed the store’s website. Using Squarespace, I created and maintained the website, adding new product and service pages. I also fostered business by creating  mass email campaigns to bring old and new customers into the physical store.'
const aboutTextP3 = 'As I transition from my career in photography into a career in coding, I am looking for a company that will help me grow my skills as a web developer, but that that is open to fresh ideas that come from my experience in the art world.'
...
const create_about_me=()=>{
    ...
    text_div.append(p1, p2, p3, links);
...
const creative_opening =$("<p>").text(
    "I thrive in front-end positions, There where I can use my coding skills and my visual arts background and create a unique and memorable user experiences.");
const list_items=[
